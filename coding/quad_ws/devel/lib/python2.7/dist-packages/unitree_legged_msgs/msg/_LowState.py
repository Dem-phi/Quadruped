...
class LowState(genpy.Message):
  _md5sum = "c18944133b8f74995a9bf0eabcfafc24"
...
float32 y
float32 z"""
  __slots__ = ['levelFlag','commVersion','robotID','SN','bandWidth','imu','motorState','bms','footForce','footForceEst','tick','wirelessRemote','reserve','crc','eeForceRaw','eeForce','position','velocity','velocity_w']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       levelFlag,commVersion,robotID,SN,bandWidth,imu,motorState,bms,footForce,footForceEst,tick,wirelessRemote,reserve,crc,eeForceRaw,eeForce,position,velocity,velocity_w
